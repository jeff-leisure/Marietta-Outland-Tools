...
Gui, 1:Show,, Marietta Outland Tools v2.3a
boolean := (boolean = 0)
return 


Test:
MsgBox % FmtSecs(8)                                  ; 14d 02h 45m 12s
...
. "`n" . FmtSecs(95, "{6:}:{4:02}") ; 20325 minutes & 12 seconds
...
Sleep 200
UniqueID := WinExist("ahk_class SDL_app")
IniRead, ChosenHotkey1, % ProfilePath, Hotkeys, Hotkey1, %A_Space%
IniRead, ChosenHotkey2, % ProfilePath, Hotkeys, Hotkey2, %A_Space%
IniRead, ChosenHotkey3, % ProfilePath, Hotkeys, Hotkey3, %A_Space%
IniRead, ChosenHotkey4, % ProfilePath, Hotkeys, Hotkey4, %A_Space%
...
if (Spellchoice1a = "Summons")
{
Gui,Add,Picture, x0 y0 BackgroundTrans AltSubmit gSumButton, %ImagePath1%
Gui, Add, Text,  xp+65 yp+24 vSumText cRed, 0
}
Else
{
...
Gui, Add, Text, W500 xp+39 yp vMyText7 cred, %Spellchoice7a%
...
Gui, Add, Text, W500 xp+39 yp vMyText8 cred, %Spellchoice8a%
...
Gui, Add, Text, W500 xp+39 yp vMyText9 cred, %Spellchoice9a%
...
Gui, Add, Text, W500 xp+39 yp vMyText10 cred, %Spellchoice10a%
...
var2 += 50
Gui, Show, x%var1% y%var2% NoActivate
WinWaitNotActive,ahk_class SDL_app
WinGet, Mode, MinMax,ahk_class SDL_app
If Mode = -1
Gui,Hide
Else
{
...
sumButton:
SumCounter:=0
SetTimer, UpdateSumCount, -10
SetTimer, UpdateSumCount, 1000
return
...
UpdateSumCount:
SumCounter++
time_display:= SumCounter
Sum_displaya:= FmtSecs(SumCounter, "{6:}:{4:02}")
if (time_display=0)
SetTimer, UpdateSumCount, off
Guicontrol,, SumText, %Sum_displaya%
return
return
...
time_displaya:= FmtSecs(time_display, "{6:}:{4:02}")
if (time_display=0)
SetTimer, UpdateOSD, off
GuiControl,, MyText, %SpellChoice1a%: %time_displaya%
return
return
...
time_display2a:= FmtSecs(time_display2, "{6:}:{4:02}")
if (time_display2=0)
SetTimer, UpdateOSD2, off
GuiControl,, MyText2, %SpellChoice2a%: %time_display2a%
return
return
...
time_display3a:= FmtSecs(time_display3, "{6:}:{4:02}")
if (time_display3=0)
SetTimer, UpdateOSD3, off
GuiControl,, MyText3, %SpellChoice3a%: %time_display3a%
return
return
...
time_display4a:= FmtSecs(time_display4, "{6:}:{4:02}")
if (time_display4=0)
SetTimer, UpdateOSD4, off
GuiControl,, MyText4, %SpellChoice4a%: %time_display4a%
return
return
...
time_display5a:= FmtSecs(time_display5, "{6:}:{4:02}")
if (time_display5=0)
SetTimer, UpdateOSD5, off
GuiControl,, MyText5, %SpellChoice5a%: %time_display5a%
return
return
...
time_display6a:= FmtSecs(time_display6, "{6:}:{4:02}")
if (time_display6=0)
SetTimer, UpdateOSD6, off
GuiControl,, MyText6, %SpellChoice6a%: %time_display6a%
return
return
...
time_display7a:= FmtSecs(time_display7, "{6:}:{4:02}")
if (time_display7=0)
SetTimer, UpdateOSD7, off
GuiControl,, MyText7, %SpellChoice7a%: %time_display7a%
return
return
...
time_display8a:= FmtSecs(time_display8, "{6:}:{4:02}")
if (time_display8=0)
SetTimer, UpdateOSD8, off
GuiControl,, MyText8, %SpellChoice8a%: %time_display8a%
return
return
...
time_display9a:= FmtSecs(time_display9, "{6:}:{4:02}")
if (time_display9=0)
SetTimer, UpdateOSD9, off
GuiControl,, MyText9, %SpellChoice9a%: %time_display9a%
return
return
...
time_display10a:= FmtSecs(time_display10, "{6:}:{4:02}")
if (time_display10=0)
SetTimer, UpdateOSD10, off
GuiControl,, MyText10, %SpellChoice10a%: %time_display10a%
return
return
